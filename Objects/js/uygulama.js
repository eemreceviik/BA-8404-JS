...
// ürün adı 5 karakterden fazla olan ürünleri console'a yazdır.
...
// En pahalı ürünü console'a yazdır.

let expensivePrice = 0;

products.forEach((value) => {
    if (expensivePrice < value.unitPrice) {
        expensivePrice = value.unitPrice;
    }
});
// console.log(expensivePrice);

let result = products.sort((a, b) => {
    // console.log('a', a.unitPrice);
    // console.log('b', b.unitPrice);
...
// En pahalı 10 ürünümün stok ve ismini console'a yazdır.
// for (let i = 0; i < 10; i++) {
//     const element = result[i];
//     console.log(element.unitsInStock, element.name);
// }

// result = result.reverse().slice(0, 10);
// result.forEach((item) => {
//     console.log(item.unitsInStock, item.name);
// });
// console.log(result);

// Stoğu 0 olan ürünlerin hangi kategoride ve hangi tedarikçiden  olduğunu listele.
// let newList = [];

// products.forEach((product) => {
//     const { unitsInStock, categoryId, supplierId } = product;
...
// let filteredList = products.filter((product) => product.unitsInStock === 0);

// const result = filteredList.map((value) => {
//     let newObject = { category: value.categoryId, supplier: value.supplierId };
//     return newObject;
// });
